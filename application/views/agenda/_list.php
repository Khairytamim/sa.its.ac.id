<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-align-left"></i> Agenda
            </li>
        </ol>
        <div class="row">
            <div class="col-sm-12">
                <form action="<?php echo base_url('index.php/agenda');?>" method="post">
...
<script type="text/javascript">
    ...
    function format (oTable, nTr) {
        ...
        return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+
            '<tr >'+
                ...
                '<td style="padding-top:10px;padding-left:10px;">'+d.agenda_ing+'</td>'+
            '</tr>'+
            '<tr>'+
                '<td><strong>Content Ind:</strong></td>'+
                '<td style="padding-top:10px;padding-left:10px;">'+d.agenda_ind+'</td>'+
            '</tr>'+
        '</table>';
    }
    ...
    $(document).ready(function() {
        var table = $('#example').dataTable( {
            "ajax": BASE_URL+"index.php/agenda/json",
            "columns": [
                {
                ...
                // { "data": "users_nama" },
                {
                    ...
                    "render": function ( data, type, row ) {
                        ...
                        var url   = "<?php echo base_url('index.php/agenda');?>";
