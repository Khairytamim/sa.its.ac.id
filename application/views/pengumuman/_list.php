<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-align-left"></i> Pengumuman
            </li>
        </ol>

        <div class="row">
            <div class="col-sm-12">
                <form action="<?php echo base_url('index.php/pengumuman');?>" method="post">
            ...
            <div class="col-sm-12">
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <!-- <th></th> -->
                            <th width='25%'>Judul IND</th>
                            <!-- <th width='25%'>Judul ING</th> -->
                            <th>Post Date</th>
                            <!-- <th>Post By</th> -->
                            <th></th>
                        </tr>
...
<script type="text/javascript">
    ...
    function format (oTable, nTr) {
        ...
        return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+
            '<tr >'+
                '<td><strong>Content Ing:</strong></td>'+
                '<td style="padding-top:10px;padding-left:10px;">'+d.pengumuman_ing+'</td>'+
            '</tr>'+
            '<tr>'+
                '<td><strong>Content Ind:</strong></td>'+
                '<td style="padding-top:10px;padding-left:10px;">'+d.pengumuman_ind+'</td>'+
            '</tr>'+
        '</table>';
    }
    ...
    $(document).ready(function() {
        var table = $('#example').dataTable( {
            "ajax": BASE_URL+"index.php/pengumuman/json",
            "columns": [
                // {
                ...
                // { "data": "users_nama" },
                {
                    ...
                    "render": function ( data, type, row ) {
                        ...
                        var url   = "<?php echo base_url('index.php/pengumuman');?>";
